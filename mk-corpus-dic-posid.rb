...
POS_TABLE = {
    ...
    "연결어미+관형형전성어미" => "연결어미+관형형전성어미", # 라+ㄴ, 라는, 라고 하는
    "대명사+주격조사" => "대명사+주격조사",
}
